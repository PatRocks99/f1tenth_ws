...
class FollowTheGap(Node):
    ...
    def __init__(self):
        ...
        self.drive_pub=self.create_publisher(AckermannDriveStamped, '/drive', 1)  #! must publish to drive. this is how the kill switch can work when in use. Messages must be stamped
